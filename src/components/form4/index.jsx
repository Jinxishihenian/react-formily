        ...
        fetchAddress: (field) => {
            const transform = (data = {}) => {
                return Object.entries(data).reduce((buf, [key, value]) => {
                    if (typeof value === 'string') return buf.concat({
                ...
                >
                    <SchemaField>
                        ...
                        <SchemaField.String
                            ...
                            x-reactions={[{
                                dependencies: ['.confirm_password'], fulfill: {
                                    state: {
                                        selfError: '{{$deps[0] && self.value && $self.value !== $deps[0] ?"确认密码不匹配":""}}',
                                    }
                                },
                            }]}
                        />
                        ...
                        <SchemaField.String
                            ...
                            x-decorator="FormItem"
                            x-component="Select"
                            enum={[{label: '男', value: 1}, {label: '女', value: 2}, {label: '第三性别', value: 3},]}
                            required
                        />
                        <SchemaField.String
                            name="birthday"
                        ...
                        >
                            <SchemaField.Object x-component="ArrayItems.Item">
                                ...
                                <SchemaField.Void
                                    ...
                                    x-reactions={[{
                                        dependencies: ['.popover.name'], fulfill: [{
                                            schema: {
                                                title: '{{$deps[0]}}'
                                            }
                                        }]
